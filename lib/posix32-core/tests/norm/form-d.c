 ...
 * Test Summary:
 *
 * Test `p32_normalize_unicode_string` function with normalization form D.
 */
...
int main (void) {
  ...
  StringPair TestNormD = {L"\u00C4\uFB01", L"\x41\u0308\uFB01"};
