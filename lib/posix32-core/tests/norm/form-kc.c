 ...
 * Test Summary:
 *
 * Test `p32_normalize_unicode_string` function with normalization form KC.
 */
...
int main (void) {
  ...
  StringPair TestNormKC = {L"\x41\u0308\uFB01", L"\u00C4\x66\x69"};
