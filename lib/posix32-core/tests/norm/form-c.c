 ...
 * Test Summary:
 *
 * Test `p32_normalize_unicode_string` function with normalization form C.
 */
...
int main (void) {
  ...
  StringPair TestNormC = {L"\x41\u0308\uFB01", L"\u00C4\uFB01"};
