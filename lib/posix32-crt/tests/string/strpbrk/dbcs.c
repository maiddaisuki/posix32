 ...
 * Test Summary:
 *
 * Test `strpbrk` function with a DBCS code page.
 */
...
static void DoTest (void) {
  ...
  assert (strpbrk (text, str6) == text);
  assert (strpbrk (text, str7) == text + 6);
  assert (strpbrk (text, str8) == text + 14);
  ...
  assert (strpbrk (text, str9) == text);
  assert (strpbrk (text, str10) == text + 3);
  assert (strpbrk (text, str11) == text + 6);
  assert (strpbrk (text, "|") == text + 2);
  ...
  assert ((str12 = strndup (invalid_text, 3)) != NULL);
  assert ((str13 = strndup (invalid_text, 1)) != NULL);

  assert (strpbrk (invalid_text, str12) == invalid_text);
  assert (strpbrk (invalid_text, str13) == NULL);
