 ...
 * Test Summary:
 *
 * Test `strcspn` function with UTF-8 (code page 65001).
 */
...
static void DoTest (void) {
  ...
  assert (strcspn (text, set7) == 9);
  assert (strcspn (text, set8) == 21);
  ...
  assert (strcspn (text, set9) == 0);
  assert (strcspn (text, "|") == 3);
  assert (strcspn (text, set10) == 4);
  assert (strcspn (text, set11) == 8);
  ...
  assert (strcspn (invalidText, set12) == 4);
  assert (strcspn (invalidText, set13) == 0);
