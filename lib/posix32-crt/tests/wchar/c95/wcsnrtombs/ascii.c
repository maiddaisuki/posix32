...
/**
 * Convenience macro to call `p32_private_wcsnrtombs_cp20127`.
 */
#define wcsnrtombs(mbs, wcs, count, size, state) p32_private_wcsnrtombs_cp20127 (mbs, wcs, count, size, state, &ascii)
