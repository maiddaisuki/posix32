...
/**
 * Convenience macro to call `p32_private_wcsnrtombs_ascii`.
 */
#define wcsnrtombs(mbs, wcs, count, size, state) p32_private_wcsnrtombs_ascii (mbs, wcs, count, size, state, &ascii)
