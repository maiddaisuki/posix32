...
/**
 * Convenience macro to call `p32_private_wcsnrtombs_utf8`.
 */
#define wcsnrtombs(mbs, wcs, count, size, state) p32_private_wcsnrtombs_utf8 (mbs, wcs, count, size, state, &utf8)
