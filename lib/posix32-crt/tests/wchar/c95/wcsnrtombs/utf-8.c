...
/**
 * Convenience macro to call `p32_private_wcsnrtombs_cp65001`.
 */
#define wcsnrtombs(mbs, wcs, count, size, state) p32_private_wcsnrtombs_cp65001 (mbs, wcs, count, size, state, &utf8)
