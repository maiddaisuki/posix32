...
/**
 * Convenience macro to call `p32_private_wcsnrtombs_posix`.
 */
#define wcsnrtombs(mbs, wcs, cnt, sz, state) p32_private_wcsnrtombs_posix (mbs, wcs, cnt, sz, state, &iso_8859_1)
