 ...
 * Test Summary:
 *
 * Test `wcsnrtombs` function with some DBCS code page.
 *
...
/**
 * Convenience macro to call `p32_private_wcsnrtombs_dbcs`.
 */
#define wcsnrtombs(mbs, wcs, count, size, state) p32_private_wcsnrtombs_dbcs (mbs, wcs, count, size, state, &cp932)
