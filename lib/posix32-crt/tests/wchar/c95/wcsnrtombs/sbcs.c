 ...
 * Test Summary:
 *
 * Test `wcsnrtombs` function with some SBCS code page.
 *
...
/**
 * Convenience macro to call `p32_private_wcsnrtombs_sbcs`.
 */
#define wcsnrtombs(mbs, wcs, size, count, state) p32_private_wcsnrtombs_sbcs (mbs, wcs, size, count, state, &cp1252)
