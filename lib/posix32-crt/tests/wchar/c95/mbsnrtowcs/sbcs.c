 ...
 * Test Summary:
 *
 * Test `mbsnrtowcs` function with some SBCS code page.
 *
...
/**
 * Convenience macro to call `p32_private_mbsnrtowcs_sbcs`.
 */
#define mbsnrtowcs(wcs, mbs, size, count, state) p32_private_mbsnrtowcs_sbcs (wcs, mbs, size, count, state, &cp1252)
