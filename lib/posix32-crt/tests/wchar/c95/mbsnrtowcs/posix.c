...
/**
 * Convenience macro to call `p32_private_mbsnrtowcs_cp28591`.
 */
#define mbsnrtowcs(wcs, mbs, cnt, sz, state) p32_private_mbsnrtowcs_cp28591 (wcs, mbs, cnt, sz, state, &iso_8859_1)
