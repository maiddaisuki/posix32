...
/**
 * Convenience macro to call `p32_private_mbsnrtowcs_utf8`.
 */
#define mbsnrtowcs(wcs, mbs, count, size, state) p32_private_mbsnrtowcs_utf8 (wcs, mbs, count, size, state, &utf8)
