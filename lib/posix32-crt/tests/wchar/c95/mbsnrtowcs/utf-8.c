...
/**
 * Convenience macro to call `p32_private_mbsnrtowcs_cp65001`.
 */
#define mbsnrtowcs(wcs, mbs, count, size, state) p32_private_mbsnrtowcs_cp65001 (wcs, mbs, count, size, state, &utf8)
