...
/**
 * Convenience macro to call `p32_private_mbsnrtowcs_cp20127`.
 */
#define mbsnrtowcs(wcs, mbs, count, size, state) p32_private_mbsnrtowcs_cp20127 (wcs, mbs, count, size, state, &ascii)
