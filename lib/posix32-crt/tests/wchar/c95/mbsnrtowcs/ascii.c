...
/**
 * Convenience macro to call `p32_private_mbsnrtowcs_ascii`.
 */
#define mbsnrtowcs(wcs, mbs, count, size, state) p32_private_mbsnrtowcs_ascii (wcs, mbs, count, size, state, &ascii)
