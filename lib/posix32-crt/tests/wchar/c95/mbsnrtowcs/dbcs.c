 ...
 * Test Summary:
 *
 * Test `mbsnrtowcs` function with some DBCS code page.
 *
...
/**
 * Convenience macro to call `p32_private_mbsnrtowcs_dbcs`.
 */
#define mbsnrtowcs(wcs, mbs, count, size, state) p32_private_mbsnrtowcs_dbcs (wcs, mbs, count, size, state, &cp932)
