...
/**
 * Convenience macro to call `p32_private_wcsrtombs_cp28591`.
 */
#define wcsrtombs(mbs, wcs, size, state) p32_private_wcsrtombs_cp28591 (mbs, wcs, size, state, &iso_8859_1)
