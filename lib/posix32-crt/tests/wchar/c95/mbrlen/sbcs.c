 ...
 * Test Summary:
 *
 * Test `mbrlen` function with some SBCS code page.
 *
...
/**
 * Convenience macro to call `p32_private_mbrlen_sbcs`.
 */
#define mbrlen(mb, count, state) p32_private_mbrlen_sbcs (mb, count, state, &cp1252)
