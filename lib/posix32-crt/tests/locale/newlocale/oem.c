 ...
 * operating system with their default OEM code page.
 *
 ...
 * OEM code pages. Any "FAIL" or "XPASS" must be investigated.
 */

#define P32_NEWLOCALE_TEST P32_NEWLOCALE_TEST_OEM
