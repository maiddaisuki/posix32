 ...
 * Test Summary:
 *
 * Test `c16rtomb` function with some DBCS code page.
 *
...
/**
 * Convenience macro to call `p32_private_c16rtomb_dbcs`.
 */
#define c16rtomb(mb, c16, state) p32_private_c16rtomb_dbcs (mb, c16, state, &cp932)
