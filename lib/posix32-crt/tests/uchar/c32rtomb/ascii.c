 ...
 * Test Summary:
 *
 * Test `c32rtomb` function with ASCII (code page 20127).
 */
...
/**
 * Convenience macro to call `p32_private_c32rtomb_cp20127`.
 */
#define c32rtomb(mb, c32, state) p32_private_c32rtomb_cp20127 (mb, c32, state, &ascii)
