...
static void P32LocaleFunction_wcsrtombs (LocaleFunctions *functions, Charset *charset) {
  if (charset->CodePage == P32_CODEPAGE_ASCII) {
    functions->F_wcsrtombs = p32_private_wcsrtombs_cp20127;
  } else if (charset->CodePage == P32_CODEPAGE_ISO_8859_1) {
    functions->F_wcsrtombs = p32_private_wcsrtombs_cp28591;
  } else if (charset->CodePage == CP_UTF8) {
    functions->F_wcsrtombs = p32_private_wcsrtombs_cp65001;
